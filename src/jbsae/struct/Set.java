...
public class Set<T> implements Iterable<T>{
    ...
    public static <T> Set<T> with(T... array){
        Set<T> set = new Set<>();
        set.addAll(array);
        return set;
    }

    public static <T> Set<T> with(Seq<T> array){
        Set<T> set = new Set<>();
        set.addAll(array);
        return set;
    }
    ...
    public void ensureCapacity(int additionalCapacity){
        ...
        if(sizeNeeded >= threshold) resize(((int)Math.ceil(sizeNeeded / loadFactor)));
    }
    ...
    public class SetIterator implements Iterable<T>, Iterator<T>{
