...
public class Draw{
    ...
    public void draw(Region region, float x, float y, float w, float h){
        draw(region, x, y, x + w, y, x + w, y + h, x, y + h);
    }

    public void draw(Region region, float x, float y, float w, float h, float r){
        Tmp.r1.set(x, y, w, h).shape(Tmp.s14).rot(r);
        draw(region, Tmp.s14.v[0].x, Tmp.s14.v[0].y, Tmp.s14.v[1].x, Tmp.s14.v[1].y, Tmp.s14.v[2].x, Tmp.s14.v[2].y, Tmp.s14.v[3].x, Tmp.s14.v[3].y);
    }
